...
import com.ps.lab.controller.LoginController;
...
public class Main {
    ...
    private static final String SCHEMA_NAME = "bookdb";
    ...
    public static void main(String[] args) {
        ...
        ItemRepository bookRepository = new ItemRepositoryImpl(jdbConnectionWrapper);
        UserServiceImpl userService = new UserServiceImpl(userRepository);
        ItemService bookService = new ItemServiceImpl(bookRepository);
        ShoppingBasketItemRepository shoppingBasketBookRepository = new ShoppingBasketItemRepositoryImpl(jdbConnectionWrapper);
